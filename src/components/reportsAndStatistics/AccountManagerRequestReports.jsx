...
const AccountManagerRequestReports = () => {
  const { t, i18n } = useTranslation("global");
  const { setTitle } = useTitle();

  useEffect(() => {
    setTitle(t('sidenav.accountManagerRequestReports'));
    ...
    <>
      ...
      <form className="table_form form-style my-3 py-3">
        <div className="row align-items-center">
          ...
          <div className="col-xl-4 col-lg-4 col-md-6 col-12">
            <label className="text-light">{t('labels.hideZeroOrders')}</label>
            <input type="text" name="hide_zero_orders" />
          </div>
...
export default AccountManagerRequestReports;