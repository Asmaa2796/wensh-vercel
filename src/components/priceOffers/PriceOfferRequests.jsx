...
const PriceOfferRequests = () => {
  const {t,i18n} = useTranslation('global');
  const { setTitle } = useTitle();

  useEffect(() => {
        setTitle(t('sidenav.priceOfferRequests'));
    ...
    <>
      ...
      <form className="table_form form-style my-3 py-3">
        <div className="row align-items-center">
          ...
          <div className="col-xl-4 col-lg-4 col-md-6 col-12">
            <label className="text-light">{t("labels.transportType")}</label>
          ...
          <div className="col-xl-4 col-lg-4 col-md-6 col-12">
            <label className="text-light">{t("labels.requestSource")}</label>
            <input type="text" name="request_source" />
          </div>
          <div className="col-xl-4 col-lg-4 col-md-6 col-12">
          ...
          <table className="table table-striped">
            ...
            <tbody>
              <tr>
                ...
                <td className="sub-text"> تفاصيل </td>
                <td className="sub-text"> احمد علي </td>
                <td className="sub-text"> احمد علي </td>
...
export default PriceOfferRequests;