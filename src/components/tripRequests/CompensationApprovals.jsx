...
const CompensationApprovals = () => {
  ...
  useEffect(() => {
        setTitle(t('sidenav.compensationApprovals'));
        ...
        <div className="row align-items-center">
          <div className="col-xl-4 col-lg-4 col-md-6 col-12">
            <label className="text-light">
              {t("labels.compensationNumber")}
            </label>
            <input type="text" name="compensation_number" />
          </div>
          <div className="col-xl-4 col-lg-4 col-md-6 col-12">
          ...
          <div className="col-xl-4 col-lg-4 col-md-6 col-12">
            <label className="text-light">{t("labels.amount")}</label>
          ...
          <table className="table table-striped">
            ...
            <tbody>
              <tr>
                ...
                <td className="sub-text">CO17718</td>
                ...
                <td className="sub-text"> مبيت يومين </td>
                <td className="sub-text"> $ 600</td>
